package com.bank.bian.financialstatements.model;
...
/**
 * The BIAN control record for this service domain: "Financial Statement Procedure".
 *
 ...
 * to its asset type (Financial Statement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Statement Procedure";
